...
class EngineArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        # LOPT (Parallel Tokenization) arguments
        model_group.add_argument(
    ...
    def create_model_config(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            enable_lopt=self.enable_lopt,
            lopt_pool_size=self.lopt_pool_size,
            lopt_chunk_size=self.lopt_chunk_size,
        )
